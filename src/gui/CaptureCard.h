...
// Failed (danger border - the §3.1 mid-capture regression owns the moment). NO animation (P2.9
// motion ruling): nothing here moves except by data. All tone-bearing text is Labels (RULE2 walker).
